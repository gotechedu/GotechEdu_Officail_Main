...
function Navbar() {
  ...
  const handleLearningHubEnter = () => {
    if (learningHubTimeoutRef.current) clearTimeout(learningHubTimeoutRef.current);
                    ...
                    <div className="mt-4 pt-3 border-t border-slate-100 flex items-center justify-between rounded-xl bg-slate-50/80 px-4 py-2.5">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-xs font-medium text-slate-600">
                          Need an architectural audit or custom enterprise requirement?
                        </span>
                      </div>
                      <Link
                        href="/contact"
        ...
        <div className="border-b border-slate-200 bg-white px-5 py-5 md:hidden shadow-xl max-h-[85vh] overflow-y-auto animate-fadeIn">
          <nav className="flex flex-col gap-2">
            <Link
              ...
              className={`rounded-xl px-4 py-2.5 text-sm font-bold transition-colors ${pathname === "/" ? "text-blue-600 font-extrabold" : "text-slate-800 hover:bg-slate-50"
                }`}
            >
              Home
            </Link>
            ...
            <div>
              ...
              >
                <span>Solutions</span>
                <ChevronDown
                  className={`w-4 h-4 text-slate-500 transition-transform ${mobileSolutionsOpen ? "rotate-180 text-blue-600" : ""
                    }`}
                />
              </button>
            ...
            <div>
              ...
              >
                <span>Learning Hub</span>
                <ChevronDown
                  className={`w-4 h-4 text-slate-500 transition-transform ${mobileLearningHubOpen ? "rotate-180 text-blue-600" : ""
                    }`}
                />
              </button>
            ...
            <Link
              href="/career"
              onClick={() => setMobileMenuOpen(false)}
              className={`rounded-xl px-4 py-2.5 text-sm font-bold transition-colors ${pathname === "/career" ? "text-blue-600 font-extrabold" : "text-slate-800 hover:bg-slate-50"
                }`}
            >
              Career
            </Link>
            ...
            <Link
              href="/blog"
              onClick={() => setMobileMenuOpen(false)}
              className={`rounded-xl px-4 py-2.5 text-sm font-bold transition-colors ${pathname === "/blog" ? "text-blue-600 font-extrabold" : "text-slate-800 hover:bg-slate-50"
                }`}
            >
              Blog
            </Link>
